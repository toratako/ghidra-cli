...
public final class GraphCommands {
    ...
    public GraphCommands(ProgramSession session, FunctionQueries functionQueries) {
        this.session = session;
        this.functionQueries = functionQueries;
        this.calls = new CallReferences(session, new AddressResolver(session));
    }

    public JsonObject handleGraphCalls(JsonObject args) throws CancelledException {
    ...
    public JsonObject handleGraphCallers(JsonObject args) throws CancelledException {
        return traverse(args, true);
    }

    public JsonObject handleGraphCallees(JsonObject args) throws CancelledException {
