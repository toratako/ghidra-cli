...
public final class BookmarkCommands {
    private final ProgramSession session;

    public BookmarkCommands(ProgramSession session) {
        this.session = session;
    }

    public JsonObject handleList() throws CancelledException {
    ...
    public JsonObject handleGet(JsonObject args) throws CancelledException {
        if (session.program() == null) return errorResult("No program loaded");
    ...
    public JsonObject handleDelete(JsonObject args) throws CancelledException {
        if (session.program() == null) return errorResult("No program loaded");
