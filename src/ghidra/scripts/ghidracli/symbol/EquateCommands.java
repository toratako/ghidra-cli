...
public final class EquateCommands {
    private final ProgramSession session;

    public EquateCommands(ProgramSession session) {
        this.session = session;
    }

    public JsonObject handleList(JsonObject args) throws Exception {
    ...
    public JsonObject handleCreate(JsonObject args) throws Exception {
        EquateTable table = table();
    ...
    public JsonObject handleAttach(JsonObject args) throws Exception {
    ...
    public JsonObject handleDetach(JsonObject args) throws Exception {
        Equate equate = requireOrdinary(args);
        Instruction instruction = instruction(args);
        int operand = operand(args, instruction);
        Address address = instruction.getAddress();
    ...
    public JsonObject handleDelete(JsonObject args) throws Exception {
        Equate equate = requireOrdinary(args);
        JsonObject result = definition(equate);
