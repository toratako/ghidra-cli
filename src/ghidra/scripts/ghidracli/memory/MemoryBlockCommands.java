...
import static ghidracli.protocol.JsonProtocol.getNonnegativeLongArg;

/** Native block edits within the request transaction owned by ProgramSession. */
public final class MemoryBlockCommands {
    private final ProgramSession session;

    public MemoryBlockCommands(ProgramSession session) {
