...
| [`NamespaceCommands`](symbol/NamespaceCommands.java), [`NamespaceSupport`](symbol/NamespaceSupport.java) | Root-relative namespace lookup, guarded hierarchy edits, recursive deletion receipts, and shared identity serialization |
