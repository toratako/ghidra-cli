...
public final class AddressCodec {
    ...
    public static boolean isExplicit(String text) {
    ...
    public static Address parse(AddressFactory factory, String text) {
    ...
    public static Address parseCanonical(AddressFactory factory, String text) {
