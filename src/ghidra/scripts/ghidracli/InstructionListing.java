...
final class InstructionListing {
    private final ProgramSession session;

    InstructionListing(ProgramSession session) {
        this.session = session;
    }

    JsonObject instructionsIn(AddressSetView range, JsonObject args) throws Exception {
