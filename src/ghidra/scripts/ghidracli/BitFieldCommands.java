...
final class BitFieldCommands {
    private final ProgramSession session;
    private final TypeResolver resolver;

    BitFieldCommands(ProgramSession session, TypeResolver resolver) {
    ...
    JsonObject handleCreate(JsonObject args) {
        ...
        try {
            ...
            return replace((Structure) target, null, StructureFields.offset(args),
    ...
    private static JsonObject replace(Structure struct, DataTypeComponent old, int offset,
