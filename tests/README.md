...
| `xref_tests`, `equate_tests`, `bookmark_tests`, `namespace_tests` | Operand/source-safe reference edits, exact constant associations, bookmark identity, guarded namespace hierarchy edits/deletion, and primary mutations |
...
| [readonly/decompile_addresses.rs](readonly/decompile_addresses.rs) | C line alignment, call-site versus callee addresses, wrapped lines, disjoint instruction locations, overlay spaces, and annotated C output |
...
| [types/archives.rs](types/archives.rs) | Native GDT dependency cycles/sharing, source identity and ABI conflicts, guarded selection, saved rollback, read-only inspection and no-clobber export |
