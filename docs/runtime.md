...
| `GHIDRA_CLI_OP_TIMEOUT` | Long analyze/import/decompile, high p-code, semantic type/field searches, variable-edit and return-type-edit socket waits, unset or 0 = unbounded |
| `GHIDRA_CLI_DECOMPILE_TIMEOUT` | Per-function native limit for `decompile`, `pcode function --high`, `function var list/get/set`, `function set-return-type`, `type uses --kind variable`, `type field uses` and `find virtual-callers`; unset or 0 = unbounded, maximum 2,147,483 seconds |
